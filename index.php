            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-4 text-center text-lg-left">
                        <a class="text-color mr-3" href="+(1800)555-5555"><strong>CALL</strong>+(1800)555-5555</a>
                    ...
                    <div class="col-lg-8 text-center text-lg-right">
                        <ul class="list-inline">
                            ...
                            ?>
                                <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="">Welcome, <?php echo $_SESSION['username']; ?></a></li>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-0 border-0 p-4">
                ...
                <div class="modal-body">
                    <form action="login_process.php" method="post" class="row">
