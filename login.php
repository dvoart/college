...
// Other PHP code for database connection, form submission, etc.
?>
            ...
            <div class="col-lg-8">
                <div class="card rounded-0 border-0 p-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        if (isset($_SESSION['incorrect_email_or_password']) && $_SESSION['incorrect_email_or_password']) {
                            echo '<div class="alert alert-danger" role="alert">Incorrect email or password. Please try again.</div>';
                            // Reset the session variable
                            $_SESSION['incorrect_email_or_password'] = false;
                        }
                        ?>
                    </div>
                </div>
